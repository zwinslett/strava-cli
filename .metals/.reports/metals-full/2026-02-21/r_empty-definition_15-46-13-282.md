error id: file://<WORKSPACE>/src/main/java/com/zwinslett/strava/StatsCommand.java:_empty_/StravaAPIClient#getRangeActivities#
file://<WORKSPACE>/src/main/java/com/zwinslett/strava/StatsCommand.java
empty definition using pc, found symbol in pc: _empty_/StravaAPIClient#getRangeActivities#
...
public class StatsCommand implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            List<Activity> recentActivityData = stravaRequest.getRangeActivitie@@s(accessToken, epochNow, sevenDaysAgo);
