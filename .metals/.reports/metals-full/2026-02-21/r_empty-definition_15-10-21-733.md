error id: file://<WORKSPACE>/src/main/java/com/zwinslett/strava/StravaAPIClient.java:_empty_/Activity#
...
public class StravaAPIClient {
    ...
    public List<Activity@@> getRangeActivities(String accessToken, int before, int after) throws Exception {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            List<Activity> recentActivityData = test.getRecentActivities(accessToken, 10);
