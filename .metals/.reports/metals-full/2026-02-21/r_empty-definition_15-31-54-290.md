error id: file://<WORKSPACE>/src/main/java/com/zwinslett/strava/StravaAPIClient.java:java/util/List#
...
public class StravaAPIClient {
    ...
    public List<Activity> getRecentActivities(String accessToken, int per_page) throws Exception {
        ...
        if (response.statusCode() == 200) {
            List<Activity> activities = this.mapper.readValue(response.body(), new TypeReference<Li@@st<Activity>>() {
            });
            return activities;
        } else {
