error id: file://<WORKSPACE>/src/main/java/com/zwinslett/strava/StatsCommand.java:java/time/Instant#today#
file://<WORKSPACE>/src/main/java/com/zwinslett/strava/StatsCommand.java
empty definition using pc, found symbol in pc: java/time/Instant#today#
...
public class StatsCommand implements Runnable {
    ...
    public void run() {
        ...
        long startOfWeek = Instant.tod@@ay.with(DayOfWeek.MONDAY).getEpochSecond();
