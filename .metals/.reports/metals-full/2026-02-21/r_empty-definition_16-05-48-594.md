error id: file://<WORKSPACE>/src/main/java/com/zwinslett/strava/RecentCommand.java:java/lang/System#out.
    ...
    public void run() {
        ...
        try {
            ...
            for (Activity a : recentActivityData) {
                System.ou@@t.println(ActivityFormatter.formatActivity(a));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
