error id: file://<WORKSPACE>/src/main/java/com/zwinslett/strava/StravaActivityRequest.java:java/net/http/HttpResponse#
...
public class StravaActivityRequest{
    ...
    public String getAccessToken() throws Exception {
        ...
        HttpRequest request = HttpRequest.newBuilder()
                ...
                .build();
        Ht@@tpResponse<String> response = client.send(request, HttpResponse.BodyHandlers.ofString());
