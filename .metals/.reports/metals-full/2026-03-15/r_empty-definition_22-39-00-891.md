error id: file://<WORKSPACE>/src/main/java/com/zwinslett/strava/cli/RecentCommand.java:_empty_/ActivityCalculator#calculateStat#
file://<WORKSPACE>/src/main/java/com/zwinslett/strava/cli/RecentCommand.java
empty definition using pc, found symbol in pc: _empty_/ActivityCalculator#calculateStat#
    ...
    public void run() {
        ...
        try {
            ...
            for(Activity a: recentActivityData){
                Stats stat = calculator.calcula@@teStat(a);
