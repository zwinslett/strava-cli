error id: file://<WORKSPACE>/src/main/java/com/zwinslett/strava/api/StravaAPIClient.java:java/lang/ExceptionInInitializerError#
file://<WORKSPACE>/src/main/java/com/zwinslett/strava/api/StravaAPIClient.java
empty definition using pc, found symbol in pc: java/lang/ExceptionInInitializerError#
...
public class StravaAPIClient {
    ...
    public void loadConfig() throws Exception {
        try {
            ...
            throw new Exc@@eptionInInitializerError(e);
        }
    }
    }
