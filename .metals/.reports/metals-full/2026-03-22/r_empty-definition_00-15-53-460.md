error id: file://<WORKSPACE>/src/main/java/com/zwinslett/strava/cli/RecentCommand.java:_empty_/Parameters#
...
public class RecentCommand implements Runnable {
    @Pa@@rameters(index = "0", description = "The number of recent activities to display (default: 1, max: 10)", arity = "0..1")
