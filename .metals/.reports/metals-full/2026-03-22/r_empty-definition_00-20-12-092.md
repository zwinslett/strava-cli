error id: file://<WORKSPACE>/src/main/java/com/zwinslett/strava/cli/StatsWeeklyCommand.java:_empty_/stravaRequest#
file://<WORKSPACE>/src/main/java/com/zwinslett/strava/cli/StatsWeeklyCommand.java
empty definition using pc, found symbol in pc: _empty_/stravaRequest#
...
public class StatsWeeklyCommand extends BaseCommand implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            List<Activity> recentActivityData = stravaReques@@t.getRangeActivities(accessToken, epochNow, sevenDaysAgo);
