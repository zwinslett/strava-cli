error id: file://<WORKSPACE>/src/main/java/com/zwinslett/strava/api/StravaAPIClient.java:java/net/http/HttpResponse#statusCode().
file://<WORKSPACE>/src/main/java/com/zwinslett/strava/api/StravaAPIClient.java
empty definition using pc, found symbol in pc: java/net/http/HttpResponse#statusCode().
