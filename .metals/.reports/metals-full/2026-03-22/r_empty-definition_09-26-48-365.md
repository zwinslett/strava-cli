error id: file://<WORKSPACE>/src/main/java/com/zwinslett/strava/api/StravaAPIClient.java:java/util/Properties#getProperty().
file://<WORKSPACE>/src/main/java/com/zwinslett/strava/api/StravaAPIClient.java
empty definition using pc, found symbol in pc: java/util/Properties#getProperty().
...
public class StravaAPIClient {
    ...
    static {
        try {
            ...
            CLIENT_ID = properties.getP@@roperty("client_id");
    ...
    public void loadConfig() throws Exception {
        // Configuration loaded in static initializer; no-op.
    }
