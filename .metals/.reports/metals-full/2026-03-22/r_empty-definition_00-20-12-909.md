error id: file://<WORKSPACE>/src/main/java/com/zwinslett/strava/cli/StatsWeeklyCommand.java:java/time/Instant#getEpochSecond().
...
public class StatsWeeklyCommand extends BaseCommand implements Runnable {
    ...
    @Override
    public void run() {
        long epochNow = Instant.now().getEpochSe@@cond();
