error id: file://<WORKSPACE>/src/main/java/com/zwinslett/strava/StravaAPIClient.java:java/net/http/HttpClient#
file://<WORKSPACE>/src/main/java/com/zwinslett/strava/StravaAPIClient.java
empty definition using pc, found symbol in pc: java/net/http/HttpClient#
...
import java.net.URI;
import java.net.http.HttpClien@@t;
