error id: file://<WORKSPACE>/src/main/java/com/zwinslett/strava/Stats.java
file://<WORKSPACE>/src/main/java/com/zwinslett/strava/Stats.java
...
```java
offset: 0
uri: file://<WORKSPACE>/src/main/java/com/zwinslett/strava/Stats.java
text:
```scala
@@
```
...
QDox parse error in file://<WORKSPACE>/src/main/java/com/zwinslett/strava/Stats.java